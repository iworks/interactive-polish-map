		...
		'options'         => array(
			...
			array(
				...
				'radio'             => array(
					...
					'after-two-columns'    => array( 'label' => __( 'After two columns', 'interactive-polish-map' ) ),
					'bottom-three-columns' => array( 'label' => __( 'After three columns', 'interactive-polish-map' ) ),
				),
